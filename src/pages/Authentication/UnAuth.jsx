...
import imgURL from "../../images/error/UnAuth.png";
            ...
            <div className="rounded-sm border border-stroke bg-white px-5 py-10 shadow-default dark:border-strokedark dark:bg-boxdark sm:py-20">
                <div className="mx-auto max-w-[410px]">
                    ...
                    <div className="mt-7.5 text-center">
                        <h2 className="mb-3 text-2xl font-bold text-black dark:text-white">Xin lỗi, bạn không có quyền thực hiện hành động này</h2>
                        <p className="font-medium">Để biết thêm chi tiết, vui lòng liên hệ với quản trị viên để được giúp đỡ!</p>
                        <div onClick={() => navigate('/')} className="mt-7.5 inline-flex items-center gap-2 rounded-md bg-primary py-3 px-6 font-medium text-white hover:bg-opacity-90" >
