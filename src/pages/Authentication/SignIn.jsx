...
const SignIn = () => {
  ...
  return (
    <div className='flex justify-center items-center my-auto h-[100vh] dark:bg-boxdark-2'>
      <ToastContainer />
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img className="hidden dark:block" src="https://khanhhung.academy/learn/assets/images/logo-png.png" alt="Logo" />
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">E-Learning</span>
              ...
              <form>
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value="Đăng nhập"
                    className={`w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90 ${isLogin ? 'opacity-50 cursor-not-allowed' : ''}`}
                    disabled={isLogin}
